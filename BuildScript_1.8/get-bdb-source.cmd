...
%WGET% -N --no-check-certificate --directory-prefix=%DLDIR% --no-check-certificate http://download.oracle.com/berkeley-db/db-%BDBFULLVER%.zip >> %LOG_DIR%\get-bdb-source.log 2>>&1
